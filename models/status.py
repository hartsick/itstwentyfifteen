...
class Status(TwitterObject):
    ...
    def check_type(self):
        status_type = None
        if 'in 2015 i' in self.stripped_text():
            status_type = 'resolution'
        elif 'help' in self.stripped_text():
            status_type = 'help'
        elif 'i fucking did it' in self.stripped_text():
